...
const homePage = {
  ...
  contact: { eyebrow: 'Appointments', heading: 'Begin with a conversation', description: 'Share a few details and our care team will confirm your visit. No obligation — just a considered first step toward clearer vision.', appointmentImagePath: '/images/appointment-cta.png', phoneNumbers: CLINIC.telephone.map((t) => t.replace('+91', '')), email: CLINIC.email, hours: CLINIC.hoursDisplay, address: CLINIC.addressDisplay },
  footer: { description: 'Comprehensive, compassionate eye care for clearer vision and long-term eye health.', treatmentLinks: keyed([{ label: 'Cataract Surgery', href: '#services' }, { label: 'LASIK & Refractive', href: '#services' }, { label: 'Glaucoma', href: '#services' }, { label: 'Retina', href: '#services' }, { label: 'Consultation', href: '#appointment' }]), exploreLinks: keyed([{ label: 'About', href: '#about' }, { label: 'Treatments', href: '#services' }, { label: 'Technology', href: '#technology' }, { label: 'Gallery', href: '#gallery' }, { label: 'Patients', href: '#testimonials' }]), address: CLINIC.addressDisplay, phone: CLINIC.telephoneDisplay, email: CLINIC.email, hours: CLINIC.hoursDisplay, copyright: '© 2026 Dr Satinder Eye Care. All rights reserved.' },
}
